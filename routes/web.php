...
Route::prefix('preinscripcion')->group(function () {
    ...
    Route::get('/admin/preinscripcion/eliminadas',[PreinscripcionController::class,'vista_eliminadas'])->name('pre.eliminadas');
...
Route::prefix('proceso')->group(function () {
    ...
    Route::get('listado-cargo/{materia_id}/{cargo_id}/{comision_id?}', [ProcesoController::class, 'vista_listadoCargo']
    )->name(
    ...
    Route::get('cambia/cierre-general/{materia_id}/{cargo_id?}/{comision_id?}/{cierre_coordinador?}', [ProcesoController::class, 'cambiaCierreGeneral'])->name(
...
Route::prefix('proceso-modular')->group(function () {
    Route::get('/listado/{materia}/{cargo_id?}', [ProcesoModularController::class, 'listado'])->name(
