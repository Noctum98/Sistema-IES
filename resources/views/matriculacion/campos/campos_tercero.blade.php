<div class="card mt-3">
    ...
    <div class="card-body">
        <h5 class="card-title">A continuación, se explica el carácter de inscripción como estudiante por el cual usted deberá optar en la opción INSCRIPCIÓN A TERCER AÑO. </h5>
        <p class="card-text">
