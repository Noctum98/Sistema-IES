<div class="card mt-3">
    ...
    <div class="card-body">
        ...
        <p>a- Tiene todos los espacios curriculares / módulos de primer año regulares.</p>
        <p>b- Y adeuda la acreditación de un espacio curricular / módulo de primer año para cumplir con la mitad de los espacios / módulos acreditados (Ud. deberá tener el pedido de condicionalidad "aprobado" en su solicitud de excepción al Consejo Académico)</p>
        <br>
