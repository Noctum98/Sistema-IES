...
<div class="card text-bg-theme">
    ...
    <div class="card-body">
        <dl class="row">
            ...
            <dd class="col-lg-10 col-xl-9">{{ optional($ticket->estado)->nombre }}</dd>

            @if($ticket->ticket)
            <dt class="text-lg-end col-lg-2 col-xl-3">Ticket</dt>
            <dd class="col-lg-10 col-xl-9">{{ optional($ticket->ticket)->id }}</dd>
            @endif
