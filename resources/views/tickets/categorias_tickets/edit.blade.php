...
@section('content')
    ...
    <div class="card text-bg-theme">
         ...
         <div class="card-header d-flex justify-content-between align-items-center p-3">
            <h4 class="m-0">{{ !empty($title) ? $title : 'Categorias Tickets' }}</h4>
            <div>
        ...
        <div class="card-body">
            ...
            <form method="POST" class="needs-validation" novalidate action="{{ route('categorias_tickets.categorias_tickets.update', $categoriasTickets->id) }}" id="edit_categorias_tickets_form" name="edit_categorias_tickets_form" accept-charset="UTF-8" >
            {{ csrf_field() }}
            <input name="_method" type="hidden" value="PUT">
            @include ('tickets.categorias_tickets.form', [
                                        'categoriasTickets' => $categoriasTickets,
                                      ])
