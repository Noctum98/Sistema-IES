	...
	<table class="table table-hover mt-4">
		...
		<tbody>
			...
			<tr style="cursor:pointer;">
				...
				<td>
					@if(Auth::user()->hasRole('admin'))
					<a href="{{ route('carrera.editar',['id'=>$carrera->id]) }}" class="mr-2 btn btn-sm btn-warning">
						Editar
					</a>
					@endif
					<a href="{{ route('materia.admin',['carrera_id'=>$carrera->id]) }}" class="btn btn-sm btn-primary">
