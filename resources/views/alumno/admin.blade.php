...
<div class="container p-3">
        ...
        <div class="col-4">
            <div class="dropdown">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li>
                        @if(isset($cargo))
                        <a class="dropdown-item @if($i == $ciclo_lectivo) active @endif " href="{{route('alumno.admin', ['ciclo_lectivo' =>$i])}}">{{$i}}</a>
                        @else
                        <a class="dropdown-item @if($i == $ciclo_lectivo) active @endif " href="{{route('alumno.admin', ['ciclo_lectivo'=> $i])}}">{{$i}}</a>
                        @endif
                    </li>
            ...
            <form method="GET" action="{{ route('alumno.adminp') }}" id="buscador-alumnos">
                <div class="row form-inline">
                    <div class="input-group">
                        ...
                        <button type="button" class="input-group-text" data-bs-toggle="modal" data-bs-target="#filtrosAlumnos"><i class="fas fa-filter text-info"></i>
    ...
    <div class="col-md-12 mt-2">
        ...
        <a class="btn btn-sm btn-success" href="{{ route('excel.all_alumnos') }}">Descargar Alumnos Verificados</a>
        @endif
        ...
        <table class="table mt-3 col-md-12">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{ route('alumno.carrera',['carrera_id'=>$carrera->id, 'ciclo_lectivo' => $ciclo_lectivo]) }}" class="btn btn-sm btn-primary">
                            Ver
                        </a>
                    </td>
                </tr>
        ...
        <table class="table mt-4">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{ route('alumno.detalle',['id'=>$alumno->id, 'ciclo_lectivo' => $ciclo_lectivo]) }}" class="btn btn-sm btn-secondary">
                            Ver datos
                        </a>
                    </td>
                </tr>
