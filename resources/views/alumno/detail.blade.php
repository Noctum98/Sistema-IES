                ...
                <div class="row">
                    ...
                    <ul class="datos-academicos col-md-6">
                        ...
                        <li>
                            ...
                            <span id="cohorte">
                        {{ $alumno->cohorte?? 'No indicada'}}
                        </span>
                            @if(
                                ((Session::has('regente') || Session::has('seccionAlumnos'))
                                    and !($alumno->cohorte))
                                    or Session::has('admin')
                                    )
                                <form id="cohorte-form-{{ $alumno->id }}">
                                    <label>
                                        <input type="text" id="change-cohorte" name="cohorte"
                                               value="{{ $alumno->cohorte }}"
                                               data-alumno-id="{{ $alumno->id }}"
                                        >
                                        Puede agregar un valor aquí
                                    </label>
                                </form>
                            @endif
                        ...
                        <a href="{{route('proceso.alumnoCarrera', ['idAlumno'=>$alumno->id, 'idCarrera' => $carrera->id])}}" class="btn btn-link position-relative p-1">
                                    ...
                                    <div class="row">
                                        @if(Session::has('admin') || Session::has('regente') || Session::has('coordinador') || Session::has('seccionAlumnos'))
                                            ...
                                            <a href="{{ route('proceso.admin',['alumno_id' => $alumno->id,'carrera_id' =>$carrera->id,'ciclo_lectivo'=>$ciclo_lectivo]) }}"
                                               class="btn btn-sm btn-primary col-md-3 mr-2">Ver materias</a>
