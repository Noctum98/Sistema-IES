...
<div class="container alumno">
	...
	<div class="col-md-12">
		...
		<div class="d-inline col-md-12">
			...
			<button class="btn btn-sm btn-danger" data-bs-toggle="modal" data-bs-target="#eliminarAlumnoModal{{$alumno->id}}">Eliminar Alumno</button>
			...
			<button class="ml-2  btn btn-sm btn-secondary {{ !$alumno->user->activo ? 'd-none' : '' }} desactivar" id="desactivar-{{$alumno->user->id}}">
				Desactivar Usuario
			</button>

			<button class="ml-2  btn btn-sm btn-success {{ $alumno->user->activo == 1 ? 'd-none' : '' }} activar" id="activar-{{$alumno->user->id}}">
				Activar Usuario
			</button>
