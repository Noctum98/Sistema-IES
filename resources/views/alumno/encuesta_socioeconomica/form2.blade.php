    ...
    <form action="{{ route('encuesta_socioeconomica.store2') }}" method="POST">
        ...
        <div class="card mb-3">
            <div class="card-body">
                <div class="form-group">
                    <label for="nombre_preferido" class="text-primary">
                        <h4>Ingresas al IES habiendo:</h4>
                    </label>
                    <div class="form-check">
            ...
            <div class="card-body">
                <div class="form-group">
                    <label for="materia_menos_costosa" class="text-primary">
                        <h4>Menciona la materia que menos te costó del nivel secundario/ del año anterior del cursado.</h4>
                    </label>
            ...
            <div class="card-body">
                <div class="form-group">
                    <label for="materia_mas_costosa" class="text-primary">
                        <h4>Menciona la materia que mas te costó del nivel secundario/ del año anterior del cursado.</h4>
                    </label>
        ...
        <div class="card mb-3">
            <div class="card-body">
                <div class="form-group">
                    <label for="nombre_preferido" class="text-primary">
                        <h4>¿En qué horario podrías realizar estas actividades?</h4>
                    </label>
                    <div class="form-check">
                        <input class="form-check-input" name="horario_actividades[]" type="checkbox" value="mañana" id="horario_actividades1" {{ is_array(old('horario_actividades')) && in_array('mañana', old('horario_actividades')) ? 'checked' : '' }}>
                        <label class="form-check-label" for="horario_actividades1">
                            Mañana
                        </label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" name="horario_actividades[]" type="checkbox" value="tarde" id="horario_actividades2" {{ is_array(old('horario_actividades')) && in_array('tarde', old('horario_actividades')) ? 'checked' : '' }}>
                        <label class="form-check-label" for="horario_actividades2">
                            Tarde
                        </label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" name="horario_actividades[]" type="checkbox" value="noche" id="horario_actividades3" {{ is_array(old('horario_actividades')) && in_array('noche', old('horario_actividades')) ? 'checked' : '' }}>
                        <label class="form-check-label" for="horario_actividades3">
                            Noche
                        </label>
                    </div>

                    <div class="form-check">
                        <input class="form-check-input" name="horario_actividades[]" type="checkbox" value="en ningun momento" id="horario_actividades4" {{ is_array(old('horario_actividades')) && in_array('en ningun momento', old('horario_actividades')) ? 'checked' : '' }}>
                        <label class="form-check-label" for="horario_actividades4">
                            En ningun momento
                        </label>
                    </div>
                </div>
        ...
        <div class="card mb-3">
            <div class="card-body">
                <div class="form-group">
                    <label for="nombre_preferido" class="text-primary">
                        <h4>¿Quisieras agregar algún otro dato que te parezca importante mencionar ya que  podría afectar tu desempeño académico?</h4>
                    </label>
                    <textarea class="form-control mt-2" id="otro_comentario" name="otro_comentario" required cols="20" rows="10">{{ old('descripcion') }}</textarea>
                </div>
            </div>
        </div>
