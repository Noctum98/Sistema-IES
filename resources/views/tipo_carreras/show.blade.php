...
<div class="card text-bg-theme">
     ...
     <div class="card-header d-flex justify-content-between align-items-center p-3">
        ...
        <div>
            <form method="POST" action="{!! route('tipo_carreras.tipo_carrera.destroy', $tipoCarrera->id) !!}" accept-charset="UTF-8">
                <input name="_method" value="DELETE" type="hidden">
                {{ csrf_field() }}

                <a href="{{ route('tipo_carreras.tipo_carrera.edit', $tipoCarrera->id ) }}" class="btn btn-primary" title="Edit Tipo Carrera">
                    <span class="fa-regular fa-pen-to-square" aria-hidden="true"></span>
                </a>

                <button type="submit" class="btn btn-danger" title="Borrar Tipo Carrera" onclick="return confirm(&quot;Click Ok para borrar Tipo Carrera.?&quot;)">
                    <span class="fa-regular fa-trash-can" aria-hidden="true"></span>
                </button>

                <a href="{{ route('tipo_carreras.tipo_carrera.index') }}" class="btn btn-primary" title="Listar Tipo Carrera">
                    <span class="fa-solid fa-table-list" aria-hidden="true"></span>
                </a>

                <a href="{{ route('tipo_carreras.tipo_carrera.create') }}" class="btn btn-secondary" title="Crear  Tipo Carrera">
