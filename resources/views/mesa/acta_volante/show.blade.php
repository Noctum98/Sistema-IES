...
<div class="container">
    ...
    @include('mesa.modals.alerta_acta_volante')
        ...
        @if(count($mesa->mesa_inscriptos_primero(true)) > 0)
            @include('mesa.acta_volante.tabla_inscriptos',['inscripciones'=>$mesa->mesa_inscriptos_primero(true),'cierre'=>$mesa->cierre_profesor])
        @else
        ...
        @if( count($mesa->mesa_inscriptos_segundo(true)) > 0)
            <h2 class="text-info">Segundo llamado</h2>
            @include('mesa.acta_volante.tabla_inscriptos',['inscripciones'=>$mesa->mesa_inscriptos_segundo(true),'cierre'=>$mesa->cierre_profesor_segundo])
        @endif
