            ...
            <tbody>
                ...
                <tr style="cursor:pointer;">
                    ...
                    <td>
                        ...
                        <a class="btn btn-sm btn-success" data-bs-toggle="modal" data-bs-target="#vistaSeleccionCarrera" id="vistaCarrera" data-loader="{{$instancia->id}}" data-attr="{{ route('carrera.vista_carrera', ['instancia' => $instancia->id]) }}">
