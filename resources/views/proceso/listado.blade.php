                ...
                <tr>
                    ...
                    <td>
                        <form action="" id="{{ $proceso->id }}" class="form_nota_global">
                            <input type="number" class="form-control nota_global {{ $proceso->nota_global >= 4 ? 'text-success' : '' }} {{ $proceso->nota_global < 4 ? 'text-danger' : '' }}" id="global-{{ $proceso->id }}" value="{{ $proceso->nota_global ? $proceso->nota_global : '' }}" @if($proceso->estado->identificador != 5 || $proceso->cierre) disabled @endif>
