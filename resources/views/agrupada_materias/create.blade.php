    ...
    <div class="card text-bg-theme">
        ...
        <div class="card-body">
            ...
            <form method="POST" class="needs-validation" novalidate
                  action="{{ route('agrupada_materias.agrupada_materia.store') }}" accept-charset="UTF-8"
                  id="create_agrupada_materia_form" name="create_agrupada_materia_form">
                {{ csrf_field() }}
                @include ('agrupada_materias.form', [
