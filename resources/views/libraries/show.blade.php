...
@section('content')
    ...
    <div class="card text-bg-theme">
        ...
        <div class="card-header d-flex justify-content-between align-items-center p-3">
            ...
            <div>
                <form method="POST" action="{!! route('libraries.library.destroy', $library->id) !!}"
                      accept-charset="UTF-8">
                    <input name="_method" value="DELETE" type="hidden">
                    {{ csrf_field() }}

                    <a href="{{ route('libraries.library.edit', $library->id ) }}" class="btn btn-primary"
                       title="Editar">
                    ...
                    <a href="{{ route('libraries.library.index') }}" class="btn btn-primary" title="Listar">
                        <span class="fa-solid fa-table-list" aria-hidden="true"></span> Listar
                    </a>

                    <a href="{{ route('libraries.library.create') }}" class="btn btn-secondary"
                       title="Agregar">
