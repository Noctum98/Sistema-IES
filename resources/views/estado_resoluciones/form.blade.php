<div class="mb-3 row">
    ...
    <div class="col-lg-10 col-xl-9">
        <input class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" name="name" type="text" id="name"
               value="{{ old('name', optional($estadoResoluciones)->name) }}" minlength="1" maxlength="191"
...
<div class="mb-3 row">
    ...
    <div class="col-lg-10 col-xl-9">
        <input class="form-control{{ $errors->has('identifier') ? ' is-invalid' : '' }}" name="identifier" type="text"
               id="identifier" value="{{ old('identifier', optional($estadoResoluciones)->identifier) }}" minlength="1"
    ...
    <div class="col-lg-10 col-xl-9">
        <div class="form-check checkbox">
            <input id="disabled_1" class="form-check-input" name="disabled" type="checkbox"
                   value="1" {{ old('disabled', optional($estadoResoluciones)->disabled) == '1' ? 'checked' : '' }}>
