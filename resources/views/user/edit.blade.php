    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="card card-header">
                <p class="card-title">Nombre y apellidos: {{$user->nombre}} {{$user->apellido}}</p>
            ...
            <div class="card card-body">
                ...
                <h6 class="text-primary">
                    ...
                    Si necesitas cambiar tus datos de perfil, por favor, comunicate con Sección Alumnos en tu Sede de cursado
                </h6>
            </div>
        </div>
