...
@section('content')
    <div class="card text-bg-theme">
        <div class="card-header d-flex justify-content-between align-items-center p-3">
            <h4 class="m-0">{{ !empty($title) ? $title : 'Mesa Folio' }}</h4>
            <div>
        ...
        <div class="card-body">
            ...
            <form method="POST" class="needs-validation" novalidate
                  action="{{ route('mesa_folios.mesa_folio.update', $mesaFolio->id) }}" id="edit_mesa_folio_form"
                  name="edit_mesa_folio_form" accept-charset="UTF-8">
                {{ csrf_field() }}
