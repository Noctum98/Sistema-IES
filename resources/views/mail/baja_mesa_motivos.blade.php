	...
	<div class="conta">
		...
		<div class="row">
			<div class="detalle-pre">
				...
				<p>Carrera: {{ $inscripcion->mesa ? $inscripcion->mesa->materia->carrera->nombre : $inscripcion->materia->carrera->nombre}}</p>
				<p>Turno: {{ $inscripcion->mesa ? $inscripcion->mesa->materia->carrera->turno : $inscripcion->materia->carrera->turno}}</p>
