...
<body>
	...
	<div class="row">
		<div class="detalle-pre">
			<br>
			<p>Usted se ha registrado en el Sistema de gestión administrativa DATAIESVU. Para que usted quede como estudiante activo en el sistema requerirá de la Validación de nuestra institución quién controlará que haya realizado y cumplimentado todos los proceso pedagógicos y administrativos para su inscripción definitiva.</p>
