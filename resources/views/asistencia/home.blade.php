...
<div class="container">
        ...
        <div class="col-4">
            <div class="dropdown">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li>
                        <a class="dropdown-item @if($i == $ciclo_lectivo) active @endif " href="{{route('asis.inicio', ['ciclo_lectivo'=> $i])}}">{{$i}}</a>
                    </li>
    ...
    <a type="button" class="list-group-item list-group-item-action border-top mt-2 text-success" data-bs-toggle="modal" data-bs-target="#eligeComision{{$materia->id}}">
        <strong>
